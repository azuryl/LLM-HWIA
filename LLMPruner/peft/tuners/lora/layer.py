...
class LoraLayer(BaseTunerLayer):
    ...
    def update_layer(
        ...
        print("use_rslora,use_dora:",use_rslora,use_dora)
        if use_rslora =='True':
            print("use_relora True")
    ...
    def dora_init(self, adapter_name: str) -> None:
        ...
        dtype_is_fp16 = True #lora_A.dtype == torch.float16
        if dtype_is_fp16:
            lora_A = lora_A.float()
            lora_B = lora_B.float()
        ...
        with gather_params_ctx(self.get_base_layer()):
            ...
            if weight.data.ndim == 4:  # For handling LoRAs applied to Conv2Ds.
                ...
                print("dora init !!!!!!!!!!!!")
                lora_weight = lora_B.weight @ lora_A.weight  #jliu
            if dtype_is_fp16: #jliu
