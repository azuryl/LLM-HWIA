...
from transformers import GenerationConfig,AutoModelForCausalLM, AutoTokenizer #jliu
from LLMPruner.models.hf_bloom.modeling_bloom import BloomForCausalLM #jliu
...
if __name__ == "__main__":
    ...
    torch_version = float('.'.join(torch.__version__.split('.')[:2])) #jliu
    args.torch_version = torch_version #jliu
