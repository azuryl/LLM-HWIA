...
def main(args):
    ...
    if args.block_wise:
        ...
        print("bloom.py pruner = tp.pruner.MetaPruner")
        ...
        print("######bloom.py ratio,num_examples:",ratio,args.num_examples)
                ...
                if args.taylor in ['param_mix', 'param_second']:
                    for j in range(args.num_examples):
                        ...
                        for module_param in model.parameters():
                            module_param.grad = ratio * module_param.grad * module_param.grad / args.num_examples #jliu
                            temp = module_param.grad * (1 - ratio)  #jliu
                            if hasattr(module_param, 'acc_grad'):
                                module_param.grad = temp  #jliu
    ...
    if args.test_after_train:
        ...
        with torch.no_grad():
            for prompt in prompts:
                input_ids = tokenizer(prompt, return_tensors="pt")['input_ids'].to(args.eval_device)#jliu
