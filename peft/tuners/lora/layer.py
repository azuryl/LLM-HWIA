...
class LoraLayer(BaseTunerLayer):
    ...
    def update_layer(
        ...
        #print("####update_layer adapter_name:",adapter_name) #jliu
    ...
    def dora_init(self, adapter_name: str) -> None:
        ...
        if self.use_rslora == True:  #jliu if use se_rslora at same time
            print("dora_init!!!:",self.scaling[adapter_name])
            scaling = self.lora_alpha[adapter_name] / self.r[adapter_name]
            print("dora_init^^^^^:",scaling)
        else : 
        ...
        with gather_params_ctx(self.get_base_layer()):
            ...
            if weight.data.ndim == 4:  # For handling LoRAs applied to Conv2Ds.
                ...
                print("AAAAVVVVVlayer.py lora_A.weight.dtype",lora_A.weight.dtype) 
...
class Linear(nn.Module, LoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("l#####ayer.py Linear inituse_rslora, r:",use_rslora,r)  #jliu
    ...
    def forward(self, x: torch.Tensor, *args: Any, **kwargs: Any) -> torch.Tensor:
        ...
        if self.disable_adapters:
            ...
            for active_adapter in self.active_adapters:
                ...
                dropout = self.lora_dropout[active_adapter]
                scaling = self.scaling[active_adapter]
                #print("lora_A.weight.dtype, scaling:",lora_A.weight.dtype, scaling)
