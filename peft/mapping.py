...
def get_peft_model(
    ...
    if hasattr(model_config, "to_dict"):
        ...
        print("get_peft_mode model_config!!!!!!!!!!!!!!!!!!!!!!!\n",model_config)

    peft_config.base_model_name_or_path = model.__dict__.get("name_or_path", None)
    print("get_peft_mode peft_config.base_model_name_or_path ###########:",peft_config.base_model_name_or_path)

    if mixed:
        return PeftMixedModel(model, peft_config, adapter_name=adapter_name)
    print("get_peft_mode PeftMixedModel !!!!!!!!!!!!!!!!!!!!!!!")

    if peft_config.task_type not in MODEL_TYPE_TO_PEFT_MODEL_MAPPING.keys() and not peft_config.is_prompt_learning:
        return PeftModel(model, peft_config, adapter_name=adapter_name)
    print("get_peft_mode PeftModel !!!!!!!!!!!!!!!!!!!!!!!")
    
    if peft_config.is_prompt_learning:
        peft_config = _prepare_prompt_learning_config(peft_config, model_config)
    print("get_peft_mode peft_config.is_prompt_learning !!!!!!!!!!!!!!!!!!!!!!!")
