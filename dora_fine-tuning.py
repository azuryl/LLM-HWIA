...
def main(args):
    ...
    if device == 'cuda':
        model.half()
        print("!!!!!fine-tuning.py device:", device)
    ...
    print("#######fine-tuning.py  after config:",config)
    model = get_peft_model(model, config)
    print("dora fine-tuning.py  after get_peft_model")
    ...
    print("fine-tuning.py args.use_fp16:",args.use_fp16)
    ...
    trainer = transformers.Trainer(
        ...
        ), #fp16=args.use_fp16, optim="adamw_torch", Jliu
...
if __name__ == "__main__":
    ...
    parser.add_argument('--learning_rate', type=float, default=4e-4, help='learning rate') #3e-4
    ...
    parser.add_argument('--lora_alpha', type=int, default=128, help='lora alpha') #16  jliu
    parser.add_argument('--lora_dropout', type=float, default=0.0, help='lora dropout') #0.05 jliu
    ...
    parser.add_argument('--use_dora', default=False)
    parser.add_argument('--use_rslora', default=False)
