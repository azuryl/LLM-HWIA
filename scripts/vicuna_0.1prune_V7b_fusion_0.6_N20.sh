prune_ckpt_path='vicuna_prune_0.1_block_wise_param_second_fusion0.6_V7B_N20'
tune_ckpt_path='vicuna_0.1_param_second_block_wise_fusion0.6_V7B_N20'
prune_ratio='0.1'
num_examples='20'
...
#CUDA_VISIBLE_DEVICES=$nGPU2 python hf_prune.py --pruning_ratio $prune_ratio --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor param_second --save_model --num_examples $num_examples --evratio 0.6 --base_model lmsys/vicuna-7b-v1.5
echo "[FINISH] - Finish Pruning Model"

echo "[START] - Start Tuning"
#CUDA_VISIBLE_DEVICES=$nGPU2 python post_training.py --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin --data_path yahma/alpaca-cleaned --output_dir tune_log/$tune_ckpt_path --wandb_project llama_tune --lora_r 8 --num_epochs 2 --learning_rate 1e-4 --batch_size 64
...
#CUDA_VISIBLE_DEVICES=$nGPU2 bash scripts/evaluate.sh $base_model tune_log/$tune_ckpt_path prune_log/$prune_ckpt_path  200
