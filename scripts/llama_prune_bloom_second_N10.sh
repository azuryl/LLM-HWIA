prune_ckpt_path='llama_prune_0.25_block_wise_param_second_bloom_N10'
tune_ckpt_path='llama_0.25_param_second_block_wise_bloom_N10'
...
CUDA_VISIBLE_DEVICES=7 bash scripts/evaluate.sh $base_model tune_log/$tune_ckpt_path prune_log/$prune_ckpt_path/  200

echo "[START] - Start Test MAC"
python test_speedup_bloom.py --base_model   $base_model --model_type pruneLLM  --ckpt  prune_log/$prune_ckpt_path/pytorch_model.bin