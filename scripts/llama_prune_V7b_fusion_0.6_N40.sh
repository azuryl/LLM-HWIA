prune_ckpt_path='llama_prune_0.2_block_wise_param_second_fusion0.6_V7B_N40'
tune_ckpt_path='llama_0.2_param_second_block_wise_fusion0.6_V7B_N40'
...
CUDA_VISIBLE_DEVICES=4 bash scripts/evaluate.sh lmsys/vicuna-7b-v1.5 tune_log/llama_0.2_param_second_block_wise_fusion0.6_V7B_N40 prune_log/llama_prune_0.2_block_wise_param_second_fusion0.6_V7B_N40/  200
