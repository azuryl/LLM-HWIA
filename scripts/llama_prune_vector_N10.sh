prune_ckpt_path='llama_prune_0.2_block_wise_vectorize_N10'
tune_ckpt_path='llama_0.2_vectorize_block_wise_N10'
...
CUDA_VISIBLE_DEVICES=5 python hf_prune.py --pruning_ratio 0.20 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor vectorize --save_model  --num_examples 10
