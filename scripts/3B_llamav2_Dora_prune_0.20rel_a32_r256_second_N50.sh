lora_r='256'
lora_alpha='32'
prune_ckpt_path='open_llama_3b_v2_prune_0.20020_block_wise_param_second_N50'
tune_ckpt_path='open_llama_3b_v2_0.2020real_param_second_block_wise_N50_Dora_a32_r256'
num_examples='50'
...
CUDA_VISIBLE_DEVICES=$nGPU python fine-tuning.py --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin --data_path yahma/alpaca-cleaned --output_dir tune_log/$tune_ckpt_path --wandb_project llama_tune --lora_r $lora_r --lora_alpha $lora_alpha --num_epochs 2 --learning_rate 4e-4 --batch_size 64   --use_dora True  --use_rslora False
