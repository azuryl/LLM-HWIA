prune_ckpt_path='llama_prune_0.2_block_wise_param_second_N50'
tune_ckpt_path='7B_llama_0.2_param_second_block_wise_0.6_N50_Reslor'
num_examples='50'
...
echo "lora_r is $lora_r"
echo "lora_alpha is $lora_alpha"
echo "GPU is $nGPU"
...
CUDA_VISIBLE_DEVICES=$nGPU python fine-tuning.py --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin --data_path yahma/alpaca-cleaned --output_dir tune_log/$tune_ckpt_path --wandb_project llama_tune --lora_r $lora_r --lora_alpha $lora_alpha --num_epochs 2 --learning_rate 1e-4 --batch_size 16  --use_dora False  --use_fp16 True --use_rslora True
