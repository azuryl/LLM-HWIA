prune_ckpt_path='llama_prune_0.25_block_wise_param_second_baichuan_N10'
tune_ckpt_path='llama_0.25_param_second_block_wise_baichuan_N10'
...
CUDA_VISIBLE_DEVICES=1 bash scripts/evaluate.sh $base_model tune_log/$tune_ckpt_path prune_log/$prune_ckpt_path/  200
