prune_ckpt_path='llama_prune_0.2_block_wise_param_vector_V7B_N20'
tune_ckpt_path='llama_0.2_param_vector_block_wise_V7B_N20'
...
CUDA_VISIBLE_DEVICES=6 python hf_prune.py --pruning_ratio 0.20 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor param_second --save_model --num_examples 20 --evratio 1 --base_model lmsys/vicuna-7b-v1.5
