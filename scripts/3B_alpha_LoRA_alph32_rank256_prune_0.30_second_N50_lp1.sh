lora_r='256'
lora_alpha='32'
prune_ckpt_path='alpha-3b_prune_0.30_block_wise_param_second_N50'
tune_ckpt_path='alpha-3b_param_0.30_second_block_wise_N50_LoRA_alp32_r256_lp'
num_examples='50'
base_model='openllmplayground/openalpaca_3b_600bt_preview'
prune_ratio='0.30'
nGPU='7'
epoch='1400'
evratio='1'
...
CUDA_VISIBLE_DEVICES=$nGPU python opt-fine-tuning.py --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin --data_path yahma/alpaca-cleaned --output_dir tune_log/$tune_ckpt_path --wandb_project llama_tune --lora_r $lora_r --num_epochs 2 --learning_rate 1e-4 --batch_size 64   --use_dora False  --use_fp16 True --use_rslora False
...
#CUDA_VISIBLE_DEVICES=$nGPU python fine-tuning.py --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin --data_path yahma/alpaca-cleaned --output_dir tune_log/$tune_ckpt_path --wandb_project llama_tune --lora_r $lora_r  --lora_alpha $lora_alpha --num_epochs 2 --learning_rate 1e-4 --batch_size 64   --use_dora False  --use_fp16 True --use_rslora True
