prune_ckpt_path='param_first/llama_prune_0.2_block_wise_param_first_N50'
tune_ckpt_path='param_first/llama_0.2_param_first_block_wise_N50'
...
CUDA_VISIBLE_DEVICES=3 bash scripts/evaluate.sh $base_model tune_log/$tune_ckpt_path prune_log/$prune_ckpt_path  200
