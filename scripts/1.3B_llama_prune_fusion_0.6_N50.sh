prune_ckpt_path='llama_1.3B_prune_0.2_block_wise_param_second_fusion0.6_N50'
tune_ckpt_path='llama_1.3B_0.2_param_second_block_wise_fusion0.6_N50'
num_examples='50'
...
CUDA_VISIBLE_DEVICES=$nGPU bash scripts/evaluate.sh $base_model tune_log/$tune_ckpt_path prune_log/$prune_ckpt_path  400
