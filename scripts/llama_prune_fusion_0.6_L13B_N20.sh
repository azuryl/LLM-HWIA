prune_ckpt_path='llama_prune_0.2_block_wise_param_second_fusion0.6_L13B_N20'
tune_ckpt_path='llama_0.2_param_second_block_wise_fusion0.6_L13B_N20'
...
#CUDA_VISIBLE_DEVICES=6 python hf_prune.py --pruning_ratio 0.20 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor param_second --save_model --num_examples 20 --evratio 0.6 --base_model NousResearch/Llama-2-13b-hf
...
CUDA_VISIBLE_DEVICES=6 bash scripts/evaluate.sh NousResearch/Llama-2-13b-hf tune_log/llama_0.2_param_second_block_wise_fusion0.6_L13B_N20 prune_log/llama_prune_0.2_block_wise_param_second_fusion0.6_L13B_N20/  200
