prune_ckpt_path='llamav2_prune_0.2_adap_block_wise_param_vec_fusion_global_N100'
tune_ckpt_path='llamav2_0.2_param_vec_block_wise_vecfusion_glob_N100_Lora'
num_examples='100'
...
#CUDA_VISIBLE_DEVICES=0 python hf_prune.py --pruning_ratio 0.20 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor --test_after_train --taylor param_second --save_model #CUDA_VISIBLE_DEVICES=$nGPU python hf_prune.py --base_model $base_model --pruning_ratio 0.50 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor vec_fuse --save_model --num_examples $num_examples --evratio 1 
CUDA_VISIBLE_DEVICES=$nGPU python hf_prune.py --base_model $base_model --pruning_ratio $prune_ratio --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor vec_fuse --save_model --num_examples $num_examples --evratio 1 --global_pruning
...
CUDA_VISIBLE_DEVICES=$nGPU python fine-tuning.py --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin --data_path yahma/alpaca-cleaned --output_dir tune_log/$tune_ckpt_path --wandb_project llama_tune --lora_r 8 --num_epochs 2 --learning_rate 1e-4 --batch_size 64 --use_dora False  --use_rslora False --extra_val_dataset wikitext2,ptb
...
CUDA_VISIBLE_DEVICES=$nGPU python test_speedup.py --base_model   $base_model --model_type pruneLLM  --ckpt  prune_log/$prune_ckpt_path/pytorch_model.bin --lora_ckpt tune_log/$tune_ckpt_path
