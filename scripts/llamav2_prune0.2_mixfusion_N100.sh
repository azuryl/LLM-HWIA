prune_ckpt_path='llamav2_prune_0.2_block_wise_param_mix_fuse_N100'
tune_ckpt_path='llamav2_0.2_param_mix_block_wise_fuse_N100_Lora'
num_examples='100'
...
#CUDA_VISIBLE_DEVICES=$nGPU python hf_prune.py --base_model $base_model --pruning_ratio $prune_ratio --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor param_mix --save_model --num_examples $num_examples --evratio 1 
...
#CUDA_VISIBLE_DEVICES=$nGPU python fine-tuning.py --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin --data_path yahma/alpaca-cleaned --output_dir tune_log/$tune_ckpt_path --wandb_project llama_tune --lora_r 8 --num_epochs 2 --learning_rate 1e-4 --batch_size 64 --use_dora False  --use_rslora False
