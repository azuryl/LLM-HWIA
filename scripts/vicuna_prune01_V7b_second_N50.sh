prune_ckpt_path='vicuna_prune_0.10_block_wise_param_second_V7B_N50'
tune_ckpt_path='vicuna_0.10_param_second_block_wise_V7B_N50'
...
CUDA_VISIBLE_DEVICES=$nGPU python hf_prune.py --pruning_ratio $prune_ratio --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor param_second --save_model --num_examples $num_examples --evratio $vratio --base_model lmsys/vicuna-7b-v1.5
