prune_ckpt_path='llamav2_prune_0.2_block_wise_param_sec_fuse_N100'
tune_ckpt_path='llamav2_0.2_param_block_wise_sec_N100_Lora'
num_examples='100'
...
CUDA_VISIBLE_DEVICES=$nGPU python hf_prune.py --base_model $base_model --pruning_ratio $prune_ratio --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor sec_fuse --save_model --num_examples $num_examples --evratio 1 
