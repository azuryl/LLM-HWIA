prune_ckpt_path='llama_prune_0.25_block_wise_param_first_bloom_N10'
tune_ckpt_path='llama_0.25_param_first_block_wise_bloom_N10'
...
#CUDA_VISIBLE_DEVICES=6 python bloom.py --pruning_ratio 0.25 --device cuda  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor param_first --save_model --num_examples 10 --evratio 1.0 --base_model $base_model
echo "[FINISH] - Finish Pruning Model"

echo "[START] - Start Tuning"
#CUDA_VISIBLE_DEVICES=6 python post_training.py --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin --data_path yahma/alpaca-cleaned --output_dir tune_log/$tune_ckpt_path --wandb_project llama_tune --lora_r 8 --lora_target_modules query_key_value,dense,dense_h_to_4h --num_epochs 2 --learning_rate 1e-4 --batch_size 64
