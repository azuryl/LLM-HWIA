prune_ckpt_path='llama_prune_0.25_block_wise_param_first_baichuan_N50'
tune_ckpt_path='llama_0.25_param_first_block_wise_baichuan_N50'
...
CUDA_VISIBLE_DEVICES=6 python baichuan.py --pruning_ratio 0.25 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor param_first --save_model --num_examples 50 --evratio 1.0 --base_model $base_model
