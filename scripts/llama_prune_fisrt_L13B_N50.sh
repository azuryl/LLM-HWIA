prune_ckpt_path='llama_prune_0.2_block_wise_param_first_L13B_N50'
tune_ckpt_path='llama_tune_0.2_param_first_block_wise_L13B_N50'
...
CUDA_VISIBLE_DEVICES=3 python hf_prune.py --pruning_ratio 0.20 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor param_first --save_model --num_examples 50 --evratio 1.0 --base_model NousResearch/Llama-2-13b-hf
...
CUDA_VISIBLE_DEVICES=3 bash scripts/evaluate.sh NousResearch/Llama-2-13b-hf tune_log/$tune_ckpt_path prune_log/$prune_ckpt_path/  200 800
#CUDA_VISIBLE_DEVICES=7 bash scripts/evaluate.sh NousResearch/Llama-2-13b-hf tune_log/llama_tune_0.2_param_first_block_wise_L13B_N50 prune_log/llama_prune_0.2_block_wise_param_first_L13B_N50/  200
