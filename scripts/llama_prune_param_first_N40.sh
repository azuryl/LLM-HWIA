prune_ckpt_path='llama_prune_0.2_block_wise_param_first_N40'
tune_ckpt_path='llama_0.2_param_first_block_wise_N40'
...
CUDA_VISIBLE_DEVICES=4 python hf_prune.py --pruning_ratio 0.20 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor  --test_after_train --taylor param_first --save_model --num_examples 40
