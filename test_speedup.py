...
def main(args):
    ...
    if device == "cuda":
        model.half()
        model = model.cuda() #args.eval_device
        #model.to(args.eval_device)
    
        with torch.cuda.device(0): #jliu
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_seq_len', type=int, default=128, help='max sequence length')#jliu
    parser.add_argument('--eval_device', type=str, default="cuda", help='eval device')#jliu
